...
var cookieDiv =  "<div id='cookieSquare' class='cookieWarning '><h4>This site uses cookies for automatical sign in.</h4><a id='cookieAccept'  class='w3-margin-bottom w3-button backgroundColor w3-hover-grey w3-large w3-round-large w3-panel w3-border w3-border-black w3-card-4 w3-margin-right'>I understand</a></div>"
...
function deleteTarget(objectID,type){
  switch (type) {
    ...
    case "Task":
      ...
      $("#task_"+objectID).remove();
      dB_deleteObject(toDeleteObject);
      cal.project.remove_task_by_id(objectID)
      // console.log(toDeleteObject);
    break;
